...
// Tu código acá:
var nombre= " Oswaldo Perozo"
var el = document.querySelector("#createdBy"); // ojo con la sintaxis!!!
el.innerHTML += nombre;
...
function buildToDo(todo, index) {
  ...
  toDoCheckBox.setAttribute('id', index);
  if (todo.complete) {
...
function addToDo() {
  ...
  if(toDoValue === ''){ return alert('No puedes agregar un ToDo vacío');}
